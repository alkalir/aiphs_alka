...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/sohrabi/Desktop/monitor_for_accelerators/monitor_accelerator/further_modification/clean_test2/mb/project_1/project_1.cache/compile_simlib/riviera"
  fi

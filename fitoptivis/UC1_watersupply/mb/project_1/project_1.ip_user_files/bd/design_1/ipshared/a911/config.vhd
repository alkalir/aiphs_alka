...
constant size_AXI_sniffer_result: integer := size_AXI_event_attr + size_AXI_metricID + size_AXI_sniffer_id + size_AXI_count_out_event + size_AXI_count_out_time;
constant size_AXI_total_result: integer := size_AXI_sniffer_result+2;
...
constant size_MBTP_sniffer_result: integer := size_MBTP_event_attr + size_MBTP_metricID + size_MBTP_sniffer_id + size_MBTP_count_out_event + size_MBTP_count_out_time;
constant size_MBTP_total_result: integer := size_MBTP_sniffer_result + 2;

-- sniffer for AXI4FULL
constant AXIFULL_sniffer_en: integer := 1;
constant size_AXIFULL_count_out_event: integer := 32;
constant size_AXIFULL_count_out_time: integer := 32;
constant size_AXIFULL_sniffer_id: integer := 2;
constant size_AXIFULL_event_attr: integer := 2;
constant size_AXIFULL_metricID: integer := 2;
constant size_AXIFULL_sniffer_result: integer := size_AXIFULL_event_attr + size_AXIFULL_metricID + size_AXIFULL_sniffer_id + size_AXIFULL_count_out_event + size_AXIFULL_count_out_time;
constant size_AXIfull_total_result: integer := size_AXIfull_sniffer_result + 2;

-- compute values for lmic1
constant size1_DCI: integer := size_AXIfull_total_result + size_MBTP_total_result + size_AXI_total_result;
